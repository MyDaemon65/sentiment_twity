...
consumer_key_secret = 'consumer_secret_key'
...
#Defining Search keyword and number of tweets and searching tweets "lang": "en",
query = 'query'
max_tweets = nnnn
...
with open('tweet_json_Data.txt', encoding='utf-8') as json_file:  
 ...
 #Writing tweet dataset t0 csv file for future reference
